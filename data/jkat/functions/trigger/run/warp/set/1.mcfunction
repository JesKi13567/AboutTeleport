execute if dimension overworld run scoreboard players set #warp jkat.warp.d.1 0
execute if dimension the_nether run scoreboard players set #warp jkat.warp.d.1 -1
execute if dimension the_end run scoreboard players set #warp jkat.warp.d.1 1
