execute if dimension overworld run scoreboard players set #warp jkat.warp.d.9 0
execute if dimension the_nether run scoreboard players set #warp jkat.warp.d.9 -1
execute if dimension the_end run scoreboard players set #warp jkat.warp.d.9 1
