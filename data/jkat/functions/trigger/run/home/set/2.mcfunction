execute if dimension overworld run scoreboard players set @s jkat.home.d.2 0
execute if dimension the_nether run scoreboard players set @s jkat.home.d.2 -1
execute if dimension the_end run scoreboard players set @s jkat.home.d.2 1
