...
# 接受ID
execute as @s[scores={jkat.tpa.id.receive=1..}] run function jkat:trigger/run/tpa/find_id
scoreboard players set @s[scores={jkat.tpa.id.receive=0}] jkat.tpa.flag.ok 0
# 等待接受
...
# 传送冷却中
execute as @s[scores={jkat.wait=1..}] run function jkat:wait
...
## 显示
# 主手
title @s[nbt={SelectedItem: {tag: {jkat: ["guide", "player"]}}},scores={jkat.wait.pearl=0}] actionbar ["",{"text": "ID：","color": "green"},{"score":{"name": "@s","objective": "jkat.id"},"color": "green"},"  ",{"text": "模式：","color": "gold"},{"score":{"name": "@s","objective": "jkat.mode"},"color": "gold"},"  ",{"text": "冷却：","color": "yellow"},{"score":{"name": "@s","objective": "jkat.wait"},"color": "yellow"}]
title @s[nbt={SelectedItem: {tag: {jkat: ["guide", "player"]}}},scores={jkat.wait.pearl=1..}] actionbar ["",{"text": "ID：","color": "green"},{"score":{"name": "@s","objective": "jkat.id"},"color": "green"},"  ",{"text": "模式：","color": "gold"},{"score":{"name": "@s","objective": "jkat.mode"},"color": "gold"},"  ",{"text": "冷却：","color": "yellow"},{"score":{"name": "@s","objective": "jkat.wait"},"color": "yellow"},"  ",{"text": "珍珠：","color": "aqua"},{"score":{"name": "@s","objective": "jkat.wait.pearl"},"color": "aqua"}]
# 副手
title @s[nbt={Inventory: [{Slot: -106b, tag: {jkat: ["guide", "player"]}}]},scores={jkat.wait.pearl=0}] actionbar ["",{"text": "ID：","color": "green"},{"score":{"name": "@s","objective": "jkat.id"},"color": "green"},"  ",{"text": "模式：","color": "gold"},{"score":{"name": "@s","objective": "jkat.mode"},"color": "gold"},"  ",{"text": "冷却：","color": "yellow"},{"score":{"name": "@s","objective": "jkat.wait"},"color": "yellow"}]
title @s[nbt={Inventory: [{Slot: -106b, tag: {jkat: ["guide", "player"]}}]},scores={jkat.wait.pearl=1..}] actionbar ["",{"text": "ID：","color": "green"},{"score":{"name": "@s","objective": "jkat.id"},"color": "green"},"  ",{"text": "模式：","color": "gold"},{"score":{"name": "@s","objective": "jkat.mode"},"color": "gold"},"  ",{"text": "冷却：","color": "yellow"},{"score":{"name": "@s","objective": "jkat.wait"},"color": "yellow"},"  ",{"text": "珍珠：","color": "aqua"},{"score":{"name": "@s","objective": "jkat.wait.pearl"},"color": "aqua"}]