...
scoreboard objectives add jkat.flag dummy "是否接受传送"
...
scoreboard objectives add jkat.check.1 custom:walk_one_cm "移动检查1"
scoreboard objectives add jkat.check.2 custom:sprint_one_cm "移动检查2"
scoreboard objectives add jkat.check.3 custom:crouch_one_cm "移动检查3"
scoreboard objectives add jkat.check.4 custom:swim_one_cm "移动检查4"
scoreboard objectives add jkat.check.5 custom:fall_one_cm "移动检查5"
scoreboard objectives add jkat.check.6 custom:climb_one_cm "移动检查6"
scoreboard objectives add jkat.check.7 custom:damage_taken "移动检查8"
scoreboard objectives add jkat.check.8 custom:damage_resisted "移动检查9"
scoreboard objectives add jkat.check.jump custom:jump "是否跳跃"
scoreboard objectives add jkat.check.sneak custom:sneak_time "是否潜行"
...
scoreboard objectives add jkat.book trigger "获取传送指南"
...
scoreboard objectives add jkat.tpa.get dummy "请求传送的玩家ID"
