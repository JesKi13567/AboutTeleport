...
execute as @s[scores={jkat.facing=1}] run function jkat:lift/fa_loop_1
execute as @s[scores={jkat.facing=2}] run function jkat:lift/fa_loop_2
execute as @s[scores={jkat.facing=3}] run function jkat:lift/fa_loop_3
execute as @s[scores={jkat.facing=4}] run function jkat:lift/fa_loop_4