...
## 显示
execute if items entity @s[scores={jkat.mode=..7}] weapon.* written_book[custom_data={jkat: ["guide", "player"]}] run title @s actionbar ["", {text: "ID：", color: "green"}, {score: {name: "@s", objective: "jkat.id"}, color: "green"}, "  ", {text: "模式：", color: "gold"}, {score: {name: "@s", objective: "jkat.mode"}, color: "gold"}, "  ", {text: "冷却：", color: "yellow"}, {score: {name: "@s", objective: "jkat.wait"}, color: "yellow"}]
execute if items entity @s[scores={jkat.mode=8..9}] weapon.* written_book[custom_data={jkat: ["guide", "player"]}] run title @s actionbar ["", {text: "ID：", color: "green"}, {score: {name: "@s", objective: "jkat.id"}, color: "green"}, "  ", {text: "模式：", color: "gold"}, {text: "玩家间传送", color: "gold"}, "  ", {text: "等待：", color: "yellow"}, {score: {name: "@s", objective: "jkat.wait.tpa"}, color: "yellow"}]
