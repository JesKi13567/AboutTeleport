...
## 显示
execute if items entity @s[scores={jkat.mode=..7}] weapon.* written_book[custom_data~{jkat: ["guide"]}] run title @s actionbar ["", {text: "ID", color: "green"}, {storage: "jk:at", nbt: "txt.char.colon", interpret: true, color: "green"}, {score: {name: "@s", objective: "jkat.id"}, color: "green"}, "  ", {storage: "jk:at", nbt: "txt.title.mode", interpret: true, color: "gold"}, {storage: "jk:at", nbt: "txt.char.colon", interpret: true, color: "gold"}, {score: {name: "@s", objective: "jkat.mode"}, color: "gold"}, "  ", {text: "CD", color: "yellow"}, {storage: "jk:at", nbt: "txt.char.colon", interpret: true, color: "yellow"}, {score: {name: "@s", objective: "jkat.wait"}, color: "yellow"}]
execute if items entity @s[scores={jkat.mode=8..9}] weapon.* written_book[custom_data~{jkat: ["guide"]}] run title @s actionbar ["", {text: "ID", color: "green"}, {storage: "jk:at", nbt: "txt.char.colon", interpret: true, color: "green"}, {score: {name: "@s", objective: "jkat.id"}, color: "green"}, "  ", {storage: "jk:at", nbt: "txt.title.mode", interpret: true, color: "gold"}, {storage: "jk:at", nbt: "txt.char.colon", interpret: true, color: "gold"}, {storage: "jk:at", nbt: "txt.title.p2p", interpret: true, color: "gold"}, "  ", {text: "CD", color: "yellow"}, {storage: "jk:at", nbt: "txt.char.colon", interpret: true, color: "yellow"}, {score: {name: "@s", objective: "jkat.wait.tpa"}, color: "yellow"}]
