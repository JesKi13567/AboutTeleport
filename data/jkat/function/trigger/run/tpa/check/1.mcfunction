...
# 去
execute as @s[tag=!jkat_tpa_target, scores={jkat.tpa=1..}] run tellraw @p[tag=jkat_tpa_target] ["", {storage: "jk:at", nbt: "txt.jkat", interpret: true, color: "gold"}, {selector: "@p[tag=jkat_tpa_self]", hover_event: {action: "show_text", value: ""}}, " ", {storage: "jk:at", nbt: "txt.tellraw.tpa.type.tpa", interpret: true, color: "gold"}, {storage: "jk:at", nbt: "txt.char.colon", interpret: true, color: "gold"}, "\n", {storage: "jk:at", nbt: "txt.jkat", interpret: true, color: "gold"}, {storage: "jk:at", nbt: "txt.button.tpa.bool.accept", interpret: true, color: "dark_blue", click_event: {action: "run_command", command: "/trigger jkat.tpa.ok"}, hover_event: {action: "show_text", value: [{storage: "jk:at", nbt: "txt.button.tpa.bool.accept", interpret: true, color: "dark_blue"}, "\n", {text: "/trigger jkat.tpa.ok", color: "yellow"}]}}, "  ", {storage: "jk:at", nbt: "txt.button.tpa.bool.deny", interpret: true, color: "dark_red", click_event: {action: "run_command", command: "/trigger jkat.tpa.ok set -1"}, hover_event: {action: "show_text", value: [{storage: "jk:at", nbt: "txt.button.tpa.bool.deny", interpret: true, color: "dark_red"}, "\n", {text: "/trigger jkat.tpa.ok set -1", color: "yellow"}]}}]
