...
tellraw @s ["", {storage: "jk:at", nbt: "txt.jkat", interpret: true, color: "gold"}, {storage: "jk:at", nbt: "txt.tellraw.spawn.set", interpret: true, color: "gold"}, "\n", {storage: "jk:at", nbt: "spawn.d"}, ": ", {storage: "jk:at", nbt: "spawn.x"}, ", ", {storage: "jk:at", nbt: "spawn.y"}, ", ", {storage: "jk:at", nbt: "spawn.z"}, ". (", {storage: "jk:at", nbt: "spawn.rx"}, ", ", {storage: "jk:at", nbt: "spawn.ry"}, ")"]
