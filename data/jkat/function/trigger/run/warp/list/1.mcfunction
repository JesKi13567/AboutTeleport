...
function jkat:trigger/run/warp/list/2 with storage jk:at warp.temp
...
execute if score #warp.count jkat.int matches ..-1 run function jkat:trigger/run/warp/list/dialog with storage jk:at warp.temp.dialog
